...
const MASSAGES_FALLBACK = [
    { _id: '1', nom: 'Massage Suédois',     description: 'Détente profonde du corps et de l\'esprit, idéal pour évacuer le stress du quotidien.',          prix: 80,  duree: 60, image: 'src/assets/massage-sueca.png' },
    { _id: '2', nom: 'Massage Thaïlandais', description: 'Technique dynamique qui libère les tensions, stimule la circulation et redonne de l\'énergie.',   prix: 90,  duree: 60, image: 'src/assets/massage-tailandesa.png' },
    { _id: '3', nom: 'Pierres Chaudes',     description: 'Chaleur thérapeutique des pierres volcaniques pour libérer les tensions les plus profondes.',     prix: 100, duree: 90, image: 'src/assets/massagem-hotstone.png' },
];
